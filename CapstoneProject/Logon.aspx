    ...
    <div id="forgotPage" class="modal fade" role="dialog">
        <div class="modal-dialog">
            ...
            <div class="modal-content modal-black">
                ...
                <div class="modal-body modal-gold cent">
                         <div class="form-group">
                        <h3>To reset your password please have your user name ready</h3>
                        <h2>Call (248) 370-4357 </h2>
                        <h3>Your ID will be required to pick up new Password</h3>
                    </div>
                    </div>
                 <div class="modal-footer modal-black">
